...
@NodeEntity(label="对公商户")
public class DGSecB extends SecB{
	protected String label="对公商户";
	public String getLabel() {
		return label;
	}
	public DGSecB(String Org_codeJoin_code1,String Acc_name,String Id_name,String Id_type_no,String Add_code,String DateAmtCount) {
