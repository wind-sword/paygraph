...
@NodeEntity(label="单位支付账户")
public class UnitPayAccount extends PayAccount{
	...
	public UnitPayAccount(String Org_codeCst_code,String Acc_name,String Acc_no,String Id_type_no) {
