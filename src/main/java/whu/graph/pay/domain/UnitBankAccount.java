...
@NodeEntity(label="单位银行账户")
public class UnitBankAccount extends BankAccount{
	...
	public UnitBankAccount(String Org_codeCst_code,String Acc_name,String Acc_no,String Id_name,String Id_type_no) {
