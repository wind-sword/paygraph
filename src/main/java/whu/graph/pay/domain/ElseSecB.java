...
@NodeEntity(label="其他商户")
public class ElseSecB extends SecB{
	protected String label="其他商户";
	public String getLabel() {
		return label;
	}
	public ElseSecB(String Org_codeJoin_code1,String Acc_name,String Id_name,String Id_type_no,String Add_code,String DateAmtCount) {
