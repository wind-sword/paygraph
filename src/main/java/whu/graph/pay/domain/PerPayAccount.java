...
@NodeEntity(label="个人支付账户")
public class PerPayAccount extends PayAccount{
	...
	public PerPayAccount(String Org_codeCst_code,String Acc_name,String Acc_no,String Id_type_no) {
