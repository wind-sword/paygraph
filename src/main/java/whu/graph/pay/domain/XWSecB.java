...
@NodeEntity(label="小微商户")
public class XWSecB extends SecB{
	protected String label="小微商户";
	public String getLabel() {
		return label;
	}
	public XWSecB(String Org_codeJoin_code1,String Acc_name,String Id_name,String Id_type_no,String Add_code,String DateAmtCount) {
